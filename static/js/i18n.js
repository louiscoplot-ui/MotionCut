...
const STRINGS = {
  ...
  en: {
    ...
    'panel.export':      'Export',
    'panel.brand':       'Brand Kit',
    'magic.btn':         'Magic Edit',
    'magic.title':       'Magic Edit',
    'magic.sub':         'Drop in your media. Pick a vibe. Let MotionCut compose a first cut.',
    'magic.duration':    'Duration',
    'magic.aspect':      'Aspect',
    'magic.style':       'Style',
    'magic.pacing':      'Pacing',
    'magic.cancel':      'Cancel',
    'magic.generate':    'Generate cinematic edit',
    'brand.agency':      'Agency name',
    'brand.tagline':     'Tagline',
    'brand.primary':     'Primary',
    'brand.secondary':   'Secondary',
    'brand.font':        'Brand font',
    'brand.logo':        'Logo',
    'brand.upload_logo': 'Upload logo',
    'brand.clear':       'Clear',
  ...
  fr: {
    ...
    'panel.brand':       'Identité de marque',
    'magic.btn':         'Magic Edit',
    'magic.title':       'Magic Edit',
    'magic.sub':         'Dépose tes médias. Choisis une ambiance. MotionCut compose un premier montage.',
    'magic.duration':    'Durée',
    'magic.aspect':      'Format',
    'magic.style':       'Style',
    'magic.pacing':      'Rythme',
    'magic.cancel':      'Annuler',
    'magic.generate':    'Générer le montage cinématique',
    'brand.agency':      'Nom de l\'agence',
    'brand.tagline':     'Slogan',
    'brand.primary':     'Couleur principale',
    'brand.secondary':   'Couleur secondaire',
    'brand.font':        'Police de marque',
    'brand.logo':        'Logo',
    'brand.upload_logo': 'Téléverser logo',
    'brand.clear':       'Effacer',
